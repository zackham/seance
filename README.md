...
**License:** MIT · **Platform:** Linux (Wayland / X11) + macOS thin client · **Status:** 0.25.6
...
| ctrl+shift+home | jump to top of the rail (first pinned, else top active) |
| ctrl+shift+1 … 9 | jump to the nth circle down the rail |
